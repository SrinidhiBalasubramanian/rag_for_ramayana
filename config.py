...
class MONGO_DB:
    # URL = f'mongodb://{USERNAME}:{PASSWORD}@cluster0.d2ydjrc.mongodb.net:27017'
    URL = f"mongodb+srv://{USERNAME}:{PASSWORD}@cluster0.d2ydjrc.mongodb.net"
...
class Prompts:
    ...
    If any of the extracts do not contain information relevant to the query, mention that the information was not found for the query.
    ...
    Make sure to be very respectful and traditional in your answer. 
    Query: {query}
